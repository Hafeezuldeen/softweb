...
<html>
    <head>
		...
		background-color:rgb(170, 233, 34);
            }
            .navbar {
                width: 85%;
                margin: auto;
...
<body>
    ...
    <footer>
        <center> Copyright@2024 Developed by HAFEEZUL DEEN S </center>
    </footer>
</body>
</html>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                ...
                background-size: cover;
                background-position: center;
		background-color:rgb(110, 243, 16);
            }
            .navbar {
                width: 85%;
                margin: auto;
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    ...
                    <td> <img src="jesu.jpg"> </td>
                    <td> <img src="kavi.jpg"> </td>
                    <td> <img src="loki.jpg"> </td>
                    
                </tr>
                <tr align="center">
                    <th> HAFEEZUL DEEN S </th>
                    <th> JESU TONY </th>
                    <th> KAVI SAMY </th>
                    <th> LOGESH NARAYANAA</th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                ...
                background-size: cover;
                background-position: center;
		background-color:rgb(132, 233, 8);
            }
            .navbar {
                width: 85%;
                margin: auto;
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                ...
                background-size: cover;
                background-position: center;
		background-color:rgb(107, 234, 16);
            }
            .navbar {
                width: 85%;
                margin: auto;
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Email</span> : codejunction@gmail.com</p>
